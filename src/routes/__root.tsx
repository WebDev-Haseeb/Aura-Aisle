...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A Pakistan-based atelier composing cinematic, emotionally immersive weddings and private celebrations." },
      { name: "author", content: "Aura & Aisle" },
      { property: "og:title", content: "Aura & Aisle — Cinematic Wedding & Event Design" },
      { property: "og:description", content: "A Pakistan-based atelier composing cinematic, emotionally immersive weddings and private celebrations." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Aura & Aisle" },
